...
import static app.notesr.cli.core.util.ZipUtils.getTopLevelEntries;
import static app.notesr.cli.core.util.ZipUtils.isZipArchive;
...
public class BackupValidator {
    ...
    public static boolean isValid(String backupPath) throws BackupIOException {
        return isV1Format(backupPath) || isV2Format(backupPath) || isV3Format(backupPath);
    }

    public static boolean isV1Format(String backupPath) throws BackupIOException {
    ...
    public static boolean isV2Format(String backupPath) throws BackupIOException {
        try {
    ...
    public static boolean isV3Format(String backupPath) throws BackupIOException {
        try {
